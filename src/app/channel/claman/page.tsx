                  ...
                  <>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 10 }}>
                      ...
                      <button onClick={runClaudeAI} disabled={claudeLoading}
                        style={{ border: '1px solid #4f46e5', background: claudeLoading ? '#f8fafc' : '#fff', color: '#4f46e5', cursor: claudeLoading ? 'default' : 'pointer', fontSize: 11, fontWeight: 700, padding: '4px 10px', borderRadius: 8 }}>
