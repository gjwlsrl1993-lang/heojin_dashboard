          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3,1fr)', gap: 16, marginBottom: 20 }}>
            ...
            <div style={{ background: '#fff1f2', border: '1px solid #94a3b8', borderRadius: 16, padding: 20 }}>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, marginTop: 4 }}>
                ...
                <span style={{ fontSize: 11, color: '#757575' }}>수수료 (평균 {avgFeeRate}%, 할인 연동 슬라이딩)</span>
              </div>
            </div>
                    ...
                    {orderRows.map((r: any) => {
                      ...
                      return (
                        <tr key={r.id} style={{ borderBottom: '1px solid #f1f5f9' }}>
                          ...
                          <td style={{ padding: '8px 10px', textAlign: 'center', color: '#757575' }}>{Math.round(feeRate * 1000) / 10}%</td>
